...
export default function Home() {
    ...
    return (<div className="p-6">
            ...
            <div className="w-full relative h-screen flex  justify-center ">
                <div className="flex w-full items-center justify-center mt-0 md:mt-60 flex-col  relative">
                    ...
                    <motion.img
                        ...
                        className="hidden md:block h-[100vh] absolute left-1/2 -top-80 -ml-52 w-[100vh]"
                        alt=""
                    />
                    <div className="flex flex-col md:hidden relative overflow-hidden  h-screen w-full  items-center  justify-center ">
                        <img src={Nnnn} className="max-w-full absolute min-w-[450px] object-cover  -mt-70  " alt="" />
        ...
        <motion.footer
            ...
            transition={{ duration: 0.8, ease: "easeOut" }}
            viewport={{ once: true, amount: 0.2 }}
            className="md:max-w-[90%] mx-auto pb-0 mb-0"
        >
            <div className="flex items-top mt-32 justify-between" id="contact">
                ...
                <LuArrowUpRight className="text-6xl mt-3 md:mt-0 md:text-[6rem]" />
            </div>

            <hr className="mt-4 border-black" />

            <div className="flex  md:flex-wrap gap-8 md:gap-4 justify-center md:justify-between mt-8">
                <div className="flex  w-full md:w-fit justify-between md:justify-start     md:flex-col gap-2 md:gap-4">
                    ...
                    <span className="flex  items-center gap-2 text-[#181C14] px-4 py-1.5 w-fit rounded-xl text-2xl md:text-xl transition-all duration-300 delay-150 hover:bg-[#181C14] hover:text-white">
                        <FaBehance /> <span className="hidden md:block"> Behance  </span> 
                    </span>
                </div>
                <div className="flex w-full md:w-fit   md:flex-col gap-2 md:gap-4 text-right justify-between  md:justify-end items-start md:items-end">
                    ...
                    <span className="flex items-center gap-2 text-[#181C14] px-4 py-1.5 rounded-xl text-2xl md:text-xl transition-all duration-300 delay-150 hover:bg-[#181C14] hover:text-white">
