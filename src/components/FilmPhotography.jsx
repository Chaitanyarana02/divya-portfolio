...
const FilmPhotography = () => {
  ...
  return (
    <section className="px-6 md:px-32 py-16 bg-white  ">
      ...
      <div className="flex justify-between items-center">
        <button
          ...
          className="cursor-pointer p-4 rounded-full border border-border text-black hover:bg-black  hover:text-white text-4xl transition"
        >
          <GoArrowLeft />
        </button>
        <button
          onClick={() => handleClick("works")}
          className="cursor-pointer p-4 rounded-full rotate-180 border border-border text-black hover:bg-black  hover:text-white text-4xl transition"
        >
          <GoArrowLeft />
        </button>
      </div>
